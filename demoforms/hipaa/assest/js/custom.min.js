...
$(document).ready(function () {
  ...
  $(document).ready(function () {
    $("#hippa1").css({ display: "block" }),
      $("#hippasteponenext").click(function () {
        $("#hippa1").css({ display: "none" }),
          $("#hippa2").css({ display: "block" });
      }),
      $("#hippasteptwoback").click(function () {
        $("#hippa2").css({ display: "none" }),
          $("#hippa1").css({ display: "block" });
      }),
      $("#hippasteptwonext").click(function () {
        $("#hippa2").css({ display: "none" }),
          $("#hippa3").css({ display: "block" });
      }),
      $("#hippastepthreeback").click(function () {
        $("#hippa3").css({ display: "none" }),
          $("#hippa2").css({ display: "block" });
      }),
      $("#hippastepthreenext").click(function () {
        $("#hippa3").css({ display: "none" }),
          $("#hippa4").css({ display: "block" });
      }),
      $("#hippastepfourback").click(function () {
        $("#hippa4").css({ display: "none" }),
          $("#hippa3").css({ display: "block" });
      }),
      $("#hippastepfournext").click(function () {
        $("#hippa4").css({ display: "none" }),
          $("#hippa5").css({ display: "block" });
      }),
      $("#hippastepfiveback").click(function () {
        $("#hippa5").css({ display: "none" }),
          $("#hippa4").css({ display: "block" });
      }),
      $("#hippastepfivenext").click(function () {
        $("#hippa5").css({ display: "none" }),
          $("#hippa6").css({ display: "block" });
      }),
      $("#hippastepsixback").click(function () {
        $("#hippa6").css({ display: "none" }),
          $("#hippa5").css({ display: "block" });
      })
  }),
  $(document).ready(function () {
