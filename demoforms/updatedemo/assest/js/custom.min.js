function init_calendar(s) {
    $(".tbody").empty(), $(".events-container").empty();
    var e = $(".tbody"),
      t = s.getMonth(),
      c = s.getFullYear(),
      n = days_in_month(t, c),
      a = $("<tr class='table-row'></tr>"),
      i = s.getDate();
    s.setDate(1);
    for (var l = s.getDay(), o = 0; o < 35 + l; o++) {
      var p = o - l + 1;
      if (
        (o % 7 == 0 && (e.append(a), (a = $("<tr class='table-row'></tr>"))),
        o < l || p > n)
      ) {
        var r = $("<td class='table-date nil'></td>");
        a.append(r);
      } else {
        r = $("<td class='table-date'>" + p + "</td>");
        var d = check_events(p, t + 1, c);
        i === p &&
          0 === $(".active-date").length &&
          (r.addClass("active-date"), show_events(d, months[t], p)),
          0 !== d.length && r.addClass("event-date"),
          r.click({ events: d, month: months[t], day: p }, date_click),
          a.append(r);
      }
    }
    e.append(a), $(".year").text(c);
  }
  function days_in_month(s, e) {
    var t = new Date(e, s, 1);
    return (new Date(e, s + 1, 1) - t) / 864e5;
  }
  function date_click(s) {
    $(".events-container").show(250),
      $("#dialog").hide(250),
      $(".active-date").removeClass("active-date"),
      $(this).addClass("active-date"),
      show_events(s.data.events, s.data.month, s.data.day);
  }
  function month_click(s) {
    $(".events-container").show(250), $("#dialog").hide(250);
    var e = s.data.date;
    $(".active-month").removeClass("active-month"),
      $(this).addClass("active-month");
    var t = $(".month").index(this);
    e.setMonth(t), init_calendar(e);
  }
  function next_year(s) {
    $("#dialog").hide(250);
    var e = s.data.date,
      t = e.getFullYear() + 1;
    $("year").html(t), e.setFullYear(t), init_calendar(e);
  }
  function prev_year(s) {
    $("#dialog").hide(250);
    var e = s.data.date,
      t = e.getFullYear() - 1;
    $("year").html(t), e.setFullYear(t), init_calendar(e);
  }
  function new_event(s) {
    0 !== $(".active-date").length &&
      ...
      $("#ok-button")
        .unbind()
        .click({ date: s.data.date }, function () {
          var e = s.data.date,
            t = $("#name").val().trim(),
            c = parseInt($("#count").val().trim()),
            n = parseInt($(".active-date").html());
          0 === t.length
            ...
            : ($("#dialog").hide(250),
              ...
              new_event_json(t, c, e, n),
              e.setDate(n),
              init_calendar(e));
        }));
  }
  function new_event_json(s, e, t, c) {
    var n = {
      occasion: s,
      invited_count: e,
      year: t.getFullYear(),
    ...
    event_data.events.push(n);
  }
  function show_events(s, e, t) {
    if (
      ...
      var c = $("<div class='event-card'></div>"),
        n = $(
      ...
      $(c).css({ "border-left": "10px solid #FF1744" }),
        $(c).append(n),
        $(".events-container").append(c);
    } else
      for (var a = 0; a < s.length; a++) {
        (c = $("<div class='event-card'></div>")),
          (n = $("<div class='event-name'>" + s[a].occasion + ":</div>"));
        var i = $(
          "<div class='event-count'>" + s[a].invited_count + " Invited</div>"
        );
        !0 === s[a].cancelled &&
          ($(c).css({ "border-left": "10px solid #FF1744" }),
          (i = $("<div class='event-cancelled'>Cancelled</div>"))),
          $(c).append(n).append(i),
          $(".events-container").append(c);
      }
  }
  function check_events(s, e, t) {
    for (var c = [], n = 0; n < event_data.events.length; n++) {
      var a = event_data.events[n];
      a.day === s && a.month === e && a.year === t && c.push(a);
    }
    return c;
  }
  $(document).ready(function () {
    var s = new Date(),
      e = s.getDate();
    $(".right-button").click({ date: s }, next_year),
      $(".left-button").click({ date: s }, prev_year),
      $(".month").click({ date: s }, month_click),
      $("#add-button").click({ date: s }, new_event),
      $(".months-row").children().eq(s.getMonth()).addClass("active-month"),
      init_calendar(s),
      show_events(
        check_events(e, s.getMonth() + 1, s.getFullYear()),
        months[s.getMonth()],
        e
      );
  });
  ...
  function showfield(s) {
    (document.getElementById("div1").innerHTML =
      "pickUp" == s
        ? ' <div class="form-group slide"><label id="formlable" for="birthDate" class="col-sm-12 control-label">Pickup Date</label><div class="col-sm-12"><input required type="date" id="birthDate" class="" placeholder="Date of Birth" autofocus></div></div>'
        : ""),
      (document.getElementById("div2").innerHTML =
        "Email" == s
          ? ' <div class="form-group slide"> <label id="formlable" for="email" class="col-sm-12 control-label">Email Address</label> <div class="col-sm-12"> <input required type="text" id="text" class="" placeholder="Enter Email Address" class="form-control" autofocus> </div></div>'
          : ""),
      (document.getElementById("div3").innerHTML =
        "fax" == s
          ? '  <div class="form-group slide"> <label id="formlable" for="phonenumber" class="col-sm-12 control-label">Fax Number</label> <div class="col-sm-12"> <input required type="text" id="phonenumber" class="" name="phoneNumber" placeholder="Contact Number"> </div></div>'
          : ""),
      (document.getElementById("div4").innerHTML =
        "Other" == s
          ? ' <div class="form-group slide"> <label id="formlable" for="birthDate" class="col-sm-12 control-label">Please Explain</label> <div class="col-sm-12"> <textarea name="describe" class="form-control" id="describe" required="" rows="3" placeholder="Please Explain"></textarea> </div></div>'
          : "");
  }
  function insType() {
    var s = document.getElementById("insurancetype");
    "none" === s.style.display
      ? (s.style.display = "block")
      : (s.style.display = "none");
  }
  function emailType() {
    var s = document.getElementById("emailType");
    "none" === s.style.display
      ? (s.style.display = "block")
      : (s.style.display = "none");
  }
  function faxType() {
    var s = document.getElementById("faxType");
    "none" === s.style.display
      ? (s.style.display = "block")
      : (s.style.display = "none");
  }
  function riskType() {
    var s = document.getElementById("risktype");
    "none" === s.style.display
      ? (s.style.display = "block")
      : (s.style.display = "none");
  }
  function explainType() {
    var s = document.getElementById("explaintype");
    "none" === s.style.display
      ? (s.style.display = "block")
      : (s.style.display = "none");
  }
  ...
  $(document).ready(function () {
    $("#hipaa1").css({ display: "block" }),
      $("#hipaasteponenext").click(function () {
        $("#hipaa1").css({ display: "none" }),
          $("#hipaa2").css({ display: "block" });
      }),
      $("#hipaasteptwoback").click(function () {
        $("#hipaa2").css({ display: "none" }),
          $("#hipaa1").css({ display: "block" });
      }),
      $("#hipaasteptwonext").click(function () {
        $("#hipaa2").css({ display: "none" }),
          $("#hipaa3").css({ display: "block" });
      }),
      $("#hipaastepthreeback").click(function () {
        $("#hipaa3").css({ display: "none" }),
          $("#hipaa2").css({ display: "block" });
      }),
      $("#hipaastepthreenext").click(function () {
        $("#hipaa3").css({ display: "none" }),
          $("#hipaa4").css({ display: "block" });
      }),
      $("#hipaastepfourback").click(function () {
        $("#hipaa4").css({ display: "none" }),
          $("#hipaa3").css({ display: "block" });
      }),
      $("#hipaastepfournext").click(function () {
        $("#hipaa4").css({ display: "none" }),
          $("#hipaa5").css({ display: "block" });
      }),
      $("#hipaastepfiveback").click(function () {
        $("#hipaa5").css({ display: "none" }),
          $("#hipaa4").css({ display: "block" });
      }),
      $("#hipaastepfivenext").click(function () {
        $("#hipaa5").css({ display: "none" }),
          $("#hipaa6").css({ display: "block" });
      }),
      $("#hipaastepsixback").click(function () {
        $("#hipaa6").css({ display: "none" }),
          $("#hipaa5").css({ display: "block" });
      })
  }),
  $(document).ready(function () {
    $("#nondisclosure1").css({ display: "block" }),
      $("#nondisclosureonenext").click(function () {
        $("#nondisclosure1").css({ display: "none" }),
          $("#nondisclosure2").css({ display: "block" });
      }),
      $("#nondisclosuretwoback").click(function () {
        $("#nondisclosure2").css({ display: "none" }),
          $("#nondisclosure1").css({ display: "block" });
      }),
      $("#nondisclosuretwonext").click(function () {
        $("#nondisclosure2").css({ display: "none" }),
          $("#nondisclosure3").css({ display: "block" });
      }),
      $("#nondisclosurethreeback").click(function () {
        $("#nondisclosure3").css({ display: "none" }),
          $("#nondisclosure2").css({ display: "block" });
      }),
      $("#nondisclosurethreenext").click(function () {
        $("#nondisclosure3").css({ display: "none" }),
          $("#nondisclosure4").css({ display: "block" });
      }),
      $("#nondisclosurefourback").click(function () {
        $("#nondisclosure4").css({ display: "none" }),
          $("#nondisclosure3").css({ display: "block" });
      }),
      $("#nondisclosurefournext").click(function () {
        $("#nondisclosure4").css({ display: "none" }),
          $("#nondisclosure5").css({ display: "block" });
      }),
      $("#nondisclosurefiveback").click(function () {
        $("#nondisclosure5").css({ display: "none" }),
          $("#nondisclosure4").css({ display: "block" });
      }),
      $("#nondisclosurefivenext").click(function () {
        $("#nondisclosure5").css({ display: "none" }),
          $("#nondisclosure6").css({ display: "block" });
      }),
      $("#nondisclosuresixback").click(function () {
        $("#nondisclosure6").css({ display: "none" }),
          $("#nondisclosure5").css({ display: "block" });
      })
  }),
  $(document).ready(function () {
    $("#updatedemo1").css({ display: "block" }),
      $("#updatedemoonenext").click(function () {
        $("#updatedemo1").css({ display: "none" }),
          $("#updatedemo2").css({ display: "block" });
      }),
      $("#updatedemotwoback").click(function () {
        $("#updatedemo2").css({ display: "none" }),
          $("#updatedemo1").css({ display: "block" });
      }),
      $("#updatedemotwonext").click(function () {
        $("#updatedemo2").css({ display: "none" }),
          $("#updatedemo3").css({ display: "block" });
      }),
      $("#updatedemothreeback").click(function () {
        $("#updatedemo3").css({ display: "none" }),
          $("#updatedemo2").css({ display: "block" });
      }),
      $("#updatedemothreenext").click(function () {
        $("#updatedemo3").css({ display: "none" }),
          $("#updatedemo4").css({ display: "block" });
      }),
      $("#updatedemofourback").click(function () {
        $("#updatedemo4").css({ display: "none" }),
          $("#updatedemo3").css({ display: "block" });
      }),
      $("#updatedemofournext").click(function () {
        $("#updatedemo4").css({ display: "none" }),
          $("#updatedemo5").css({ display: "block" });
      }),
      $("#updatedemofiveback").click(function () {
        $("#updatedemo5").css({ display: "none" }),
          $("#updatedemo4").css({ display: "block" });
      }),
      $("#updatedemofivenext").click(function () {
        $("#updatedemo5").css({ display: "none" }),
          $("#updatedemo6").css({ display: "block" });
      }),
      $("#updatedemosixback").click(function () {
        $("#updatedemo6").css({ display: "none" }),
          $("#updatedemo5").css({ display: "block" });
      }),
      $("#updatedemosixnext").click(function () {
        $("#updatedemo6").css({ display: "none" }),
          $("#updatedemo7").css({ display: "block" });
      }),
      $("#updatedemosevennext").click(function () {
        $("#updatedemo7").css({ display: "none" }),
          $("#updatedemo8").css({ display: "block" });
      });
  }),
  $(document).ready(function () {
