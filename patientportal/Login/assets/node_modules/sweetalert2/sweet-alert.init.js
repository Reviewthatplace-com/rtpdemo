...
!function ($) {
    ...
    SweetAlert.prototype.init = function () {
        ...
        $(".punchedIn").click(function () {
          ...
          var steps = [
      {   
          html:" <div class='row form-group m-b-40'> <div class='col-12'> <h1 class='font-weight-bolder text-center'>02/27/21</h1></div><div class='col-12'> <h2 class='font-weight-bolder text-center'>03:30 AM</h2></div><div class='col-12'> <h2 class='font-weight-bolder text-center'>Note</h2> <textarea placeholder='Type your message here' class='form-control text-center'></textarea></div></div>",
