...
!function ($) {
    ...
    SweetAlert.prototype.init = function () {
        ...
        {
            title: "Access key has been sent to your email.",
            text: "Please enter your access key to activate email.",
            input: "text",
            showCancelButton: true,
            confirmButtonColor: "#5cb85c",
            confirmButtonText: "Submit",
  ...
  swal.queue(steps).then(function (result) {
    ...
    $("#duplicate").click(function () {
        Swal.fire({
            type: 'success',
            title: 'An Alert has been sent to the Practice'
        })
    });
  ...
  swal.queue(steps).then(function (result) {
    ...
    swal.resetDefaults()
        ...
        {
            title: "Are you sure",
            text: "You want to resend this record?",
            type: "warning",
            showCancelButton: true,
            confirmButtonColor: "#5cb85c",
...
{
    title: "Are you sure",
    text: "You want to send the selected records?",
    type: "warning",
    showCancelButton: true,
    confirmButtonColor: "#5cb85c",
