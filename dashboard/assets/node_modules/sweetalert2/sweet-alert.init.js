...
!function ($) {
    ...
    SweetAlert.prototype.init = function () {
        ...
        $('#sendalltolab').click(function () {
            Swal.fire({
                ...
                swal("Send!", "All records moved", "success");
            });
        });
        ...
        $('.sendtolab').click(function () {
            Swal.fire({
                ...
                swal("Send!", "Record moved", "success");
            });
        });
        ...
        $(".contactBlast").click(function () {
            ...
            var steps = [
        {
            title: "Are you use you want to proceed?",
            text: "You are about to send a blast to 2456 SMS and 3456 Emails.",
            type: "warning",
            showCancelButton: true,
      ...
      $(".supSign").click(function () {
          ...
          var steps = [
      {
          title: "Are you sure you want to sign 345 soaps?",
    ...
    {
        title: "Are you sure",
        text: "you want to move this appointment back to clinician review?",
        type: "warning",
        showCancelButton: true,
        confirmButtonColor: "#5cb85c",
        confirmButtonText: "Yes, Proceed",
    ...
    { 
        type: 'success',
        title: 'Moved to Clinician Review',
        showConfirmButton: false,
        timer: 1500,
    }, 
  ...
  swal.queue(steps).then(function (result) {
    ...
    $(".sendtosupSigned").click(function () {
        Swal.mixin({
            input: 'select',
            confirmButtonText: 'Next &rarr;',
            showCancelButton: true,
    ...
    {
        title: "Are you sure",
        text: "you want to send all to supsigned?",
        type: "warning",
        showCancelButton: true,
        confirmButtonColor: "#5cb85c",
        confirmButtonText: "Yes, Proceed",
  ...
  swal.queue(steps).then(function (result) {
    ...
    $(".sendtoStandingOrder").click(function () {
        Swal.mixin({
            input: 'select',
            confirmButtonText: 'Next &rarr;',
            showCancelButton: true,
    ...
    {
        title: "Are you sure",
        text: "you want to send all to Standing Order?",
        type: "warning",
        showCancelButton: true,
        confirmButtonColor: "#5cb85c",
        confirmButtonText: "Yes, Proceed",
