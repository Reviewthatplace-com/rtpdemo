...
$(function() {
    ...
    var plot = $.plot($("#data-example-0"),
        [{ data: sin, label: "Covid" }, { data: cos, label: "Flu" }], {
            series: {
    ...
    $("#data-example-0").bind("plothover", function (event, pos, item) {
        $("#x").text(pos.x.toFixed(2));
        $("#y").text(pos.y.toFixed(2));
    });

    $("#data-example-0").bind("plotclick", function (event, pos, item) {
        if (item) {
...
$(function() {
    ...
    $("#data-example-1").bind("plothover", function (event, pos, item) {
        $("#z").text(pos.x.toFixed(2));
        $("#c").text(pos.y.toFixed(2));
    });

    $("#data-example-1").bind("plotclick", function (event, pos, item) {
        if (item) {
            $("#clickdata-1").text("You clicked point " + item.dataIndex + " in " + item.series.label + ".");
            plot.highlight(item.series, item.datapoint);
        }
    });
