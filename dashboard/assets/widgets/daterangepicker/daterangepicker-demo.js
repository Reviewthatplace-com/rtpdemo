...
$(function() {
    ...
    $('#daterangepicker-custom1').daterangepicker({
            startDate: moment().subtract('days', 29),
            endDate: moment(),
            minDate: '01/01/2012',
            maxDate: '12/31/2014',
        ...
        function(start, end) {
            console.log("Callback has been called!");
            $('#daterangepicker-custom1 span').html(start.format('MMMM D, YYYY') + ' - ' + end.format('MMMM D, YYYY'));
        }
    );
    $('#daterangepicker-custom1 span').html(moment().subtract('days', 29).format('MMMM D, YYYY') + ' - ' + moment().format('MMMM D, YYYY'));
});

$(function() {
    "use strict";

    $('#daterangepicker-custom1-2').daterangepicker({
            startDate: moment().subtract('days', 29),
            endDate: moment(),
            minDate: '01/01/2012',
            maxDate: '12/31/2014',
        ...
        function(start, end) {
            console.log("Callback has been called!");
            $('#daterangepicker-custom1-2 span').html(start.format('MMMM D, YYYY') + ' - ' + end.format('MMMM D, YYYY'));
        }
    );
    $('#daterangepicker-custom1-2 span').html(moment().subtract('days', 29).format('MMMM D, YYYY') + ' - ' + moment().format('MMMM D, YYYY'));
});

$(function() {
    "use strict";

    $('#daterangepicker-custom1-1').daterangepicker({
            startDate: moment().subtract('days', 29),
            endDate: moment(),
            minDate: '01/01/2012',
            maxDate: '12/31/2014',
        ...
        function(start, end) {
            console.log("Callback has been called!");
            $('#daterangepicker-custom1-1 span').html(start.format('MMMM D, YYYY') + ' - ' + end.format('MMMM D, YYYY'));
        }
    );
    $('#daterangepicker-custom1-1 span').html(moment().subtract('days', 29).format('MMMM D, YYYY') + ' - ' + moment().format('MMMM D, YYYY'));
});
