...
$(function() {
    "use strict";
     ...
     $(".updateReview").click(function(){
          $.toast({
          heading: '',
          text: 'Ravi Agrawal updated a review',
          position: 'top-right',
          loaderBg:'#ff6849',
          icon: 'warning',
          hideAfter: 3500, 
     ...
     $(".addCatagory").click(function(){
          $.toast({
          heading: '',
          text: 'Ravi Agrawal added a catagory',
          position: 'top-right',
          loaderBg:'#ff6849',
          icon: 'warning',
          hideAfter: 3500, 
     ...
     $(".updateCatagory").click(function(){
          $.toast({
          heading: '',
          text: 'Ravi Agrawal updated a catagory',
          position: 'top-right',
          loaderBg:'#ff6849',
          icon: 'warning',
          hideAfter: 3500, 
     ...
     $(".updateTag").click(function(){
          $.toast({
          heading: '',
          text: 'Ravi Agrawal updated a tag',
          position: 'top-right',
          loaderBg:'#ff6849',
          icon: 'warning',
          hideAfter: 3500, 
     ...
     $(".uaSub").click(function(){
          $.toast({
          heading: '',
          text: 'Ravi Agrawal updated user subscription',
          position: 'top-right',
          loaderBg:'#ff6849',
          icon: 'warning',
          hideAfter: 3500, 
     ...
     $(".uaNote").click(function(){
          $.toast({
          heading: '',
          text: 'Ravi Agrawal left a note',
          position: 'top-right',
          loaderBg:'#ff6849',
          icon: 'warning',
          hideAfter: 3500, 
     ...
     $(".uaLocationInfo").click(function(){
          $.toast({
          heading: '',
          text: 'Ravi Agrawal Updated information for a Location',
          position: 'top-right',
          loaderBg:'#ff6849',
          icon: 'warning',
          hideAfter: 3500, 
     ...
     $(".uaCreateSub").click(function(){
          $.toast({
          heading: '',
          text: 'Ravi Agrawal created user subscription',
          position: 'top-right',
          loaderBg:'#ff6849',
          icon: 'warning',
          hideAfter: 3500, 
