...
swal.resetDefaults()
  ...
  swal.queue(steps).then(function (result) {
    ...
    swal.resetDefaults()
      ...
      swal.queue(steps).then(function (result) {
        ...
        $(".contactUsArchive").click(function () {
          Swal.mixin({
              input: 'select',
              confirmButtonText: 'Next &rarr;',
              showCancelButton: true,
      ...
      {
          title: "Are you sure?",
          text: "You want to archive this contact?",
          type: "warning",
          showCancelButton: true,
          confirmButtonColor: "#DD6B55",
          confirmButtonText: "Yes, archive it!",
  ...
  swal.queue(steps).then(function (result) {
    ...
    swal.resetDefaults()
        ...
        $(".deleteAppointmnet").click(function () {
          Swal.mixin({
              input: 'select',
              confirmButtonText: 'Next &rarr;',
              showCancelButton: true,
...
swal.queue(steps).then(function (result) {
  ...
  swal.resetDefaults()
    ...
    $(".approveAppointmnet").click(function () {
      Swal.mixin({
          input: 'select',
          confirmButtonText: 'Next &rarr;',
          showCancelButton: true,
...
swal.queue(steps).then(function (result) {
  ...
  swal.resetDefaults()
          ...
          showCancelButton: true,
          confirmButtonColor: "#00c292",
          confirmButtonText: "Delegate Access",
          closeOnConfirm: false,
          },
          {      type: 'success',
          title: 'Sent',
