...
function step_one_validation() {
  ...
  error_step_one =
    error_filler_name + error_filler_relationship + error_filler_hyk;
...
function step_three_validation() {
  ...
  error_step_third =
    error_emg_contact + error_emg_relationship + error_emg_phone;
...
function step_seven_validation() {
  ...
  //violence validation
  if (
    $('input[name="Verbal"]:checked').length != 0 ||
    $('input[name="Physical"]:checked').length != 0 ||
...
function step_sixteen_validation() {
  ...
  if (
    $('input[name="ac_1_1"]:checked').length == 0 &&
    $('input[name="ac_1_2"]:checked').length == 0 &&
    $('input[name="ac_1_3"]:checked').length == 0 &&
    $('input[name="ac_1_4"]:checked').length == 0 &&
  ...
  if (
    $('input[name="ac_2_1"]:checked').length == 0 &&
    $('input[name="ac_2_2"]:checked').length == 0 &&
    $('input[name="ac_2_3"]:checked').length == 0 &&
    $('input[name="ac_2_4"]:checked').length == 0 &&
  ...
  if (
    $('input[name="ac_3_1"]:checked').length == 0 &&
    $('input[name="ac_3_2"]:checked').length == 0 &&
    $('input[name="ac_3_3"]:checked').length == 0 &&
    $('input[name="ac_3_4"]:checked').length == 0 &&
